...
def SendMailwAttachment_(List_, Ek):
    ...
    # /// MAIL DEĞİŞKENLER
    From_ = "TEAM_DIGITAL_DSCO@smtp.turkcell.com.tr"
    FromAlias_ = "TEAM_DIGITAL_DSCO"
    #To_ = ["mert.kulac@turkcell.com.tr"]
    To_ = ["TEAM-SOL-TAC-SA@turkcell.com.tr", "TEAM-SOLSD-TSE@turkcell.com.tr","NT-SOG-CSO-DSCO@turkcell.entp.tgc","TEAM-SOL-TAC-MA@turkcell.com.tr", "TEAM-SOLSD-DESTECH@turkcell.com.tr", "TEAM-KURUMSAL-KAMU@turkcell.entp.tgc"]
    # cc_ = ["oguz.isikoglu@turkcell.com.tr", "mert.kulac@turkcell.com.tr", "burak.icigen@turkcell.com.tr","can.gonul@turkcell.com.tr"]
    Subject_ = "DDOS 2.0 Tüm Müşteri Devre Kontrolleri - Aksiyon VAR"
    AttachmentList_ = [Ek]
    ...
    MailText_ = """\
            <p>Merhaba,</p>
            <p>Aşağıdaki listede bulunan, Arbor üzerindeki DDOS 2.0 ile korunan IP’lerin, DDOS 2.0 data anonslarında problem gözlemlenmiştir. </p>
            <p>DDOS 2.0 devrelerin tespit edilerek, up-down/recieve routes/prefix/routing vb. kontrollerin sağlanmasını rica ederiz. </p>

            <p>Not: Müşteri kontrolleri için ortak alandaki dokümandan faydalanabilirsiniz. ("\\\\tcomfsr01\\Tellcom\\Network\\NETWORK-MERKEZI-DESTEK\\KTD\\TAC\\DOKUMAN\\DDOScript") </p>
            ...
            <p>Soru ve önerileriniz için Mert Kulaç, Burak İçigen ve Gönül Ece Can'dan destek alabilirsiniz.<p>
            <p>&nbsp;</p>

                        """ % Table_

    # /// FONKSİYON MAIN BODY /// DO NOT CHANGE
...
def SendMailwAttachment_2():
    ...
    # To_ = ["TEAM-SOL-TAC-SA@turkcell.com.tr", "TEAM-SOLSD-TSE@turkcell.com.tr","NT-SOG-CSO-DSCO@turkcell.entp.tgc","TEAM-SOL-TAC-MA@turkcell.com.tr", "TEAM-SOLSD-DESTECH@turkcell.com.tr", "TEAM-KURUMSAL-KAMU@turkcell.entp.tgc"]
    # cc_ = ["oguz.isikoglu@turkcell.com.tr", "mert.kulac@turkcell.com.tr", "burak.icigen@turkcell.com.tr","can.gonul@turkcell.com.tr"]
    Subject_ = "DDOS 2.0 Tüm Müşteri Devre Kontrolleri - Aksiyon YOK"

    MailText_ = """\
            <p>Merhaba,</p>
            <p>Tüm müşterilerin DDOS 2.0 devrelerinde anons problemi yoktur. </p>

            <p>İyi çalışmalar </p>

            <p>Soru ve önerileriniz için eskalasyon süreci ve Burak İçigen-Mert Kulaç' destek alabilirsiniz.<p>
            <p>&nbsp;</p>
